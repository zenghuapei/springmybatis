...
//      simpleAuthorInfo.addStringPermissions(permissionList);  
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authcToken) throws AuthenticationException {  
        ...
        UserInfo userInfo = userInfoService.getOneUserInfo(token.getUsername());  
        
        
      if(null != userInfo){  
    	  if(userInfo.getAccount().getAccount().equals(token.getUsername())){   		  
    		  AuthenticationInfo authcInfo = new SimpleAuthenticationInfo(userInfo.getAccount().getAccount(), userInfo.getAccount().getPassWord(),this.getName());  
